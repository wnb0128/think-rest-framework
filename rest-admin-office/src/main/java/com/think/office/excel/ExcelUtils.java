package com.think.office.excel;
...
public class ExcelUtils {
    ...
    public static List<Object> readExcel(InputStream inputStream, int sheetNum, int headerRowNum, BaseRowModel rowModel) throws Exception {
        ...
        if (sheetNum < 0) return data;
        if (headerRowNum < 0) return data;
...
//        FileInputStream fis = new FileInputStream(new File("C:\\Users\\wnb\\Desktop\\财务2020-07-14.xlsx"));
