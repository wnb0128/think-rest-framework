...
//    	}
        ...
        String retVal = "";
        try {
            UrlEncodedFormEntity entity = new UrlEncodedFormEntity(getNameValueList(params), charset);
...
//        		log.info("connection  end,sartTime = "+startTime+"  , endTime =" + endTime +" , times:"+(endTime-startTime));
    ...
    public String get(String url, Map<String, String> params, int timeout, String charset) throws Exception {
        ...
        String retVal = "";
        try {
            String s = URLEncodedUtils.format(getNameValueList(params), charset);
    ...
    public static String get(String url, Map<String, String> params, int timeout, String charset, String fNameEndChar) throws Exception {
        ...
        try {
            String paramStr = URLEncodedUtils.format(getNameValueList(params), charset);
...
//        httpclient.getParams().setParameter(HttpMethodParams.RETRY_HANDLER,new DefaultHttpMethodRetryHandler());
        ...
        try {
            ...
            if (resp.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {
                ...
                BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(httpentity.getContent(), contentCharSet));
                String line = "";
                while ((line = bufferedReader.readLine()) != null) {
                    retVal += line;
                }
...
//            retVal = EntityUtils.toString(resp.getEntity(), charset);
    ...
    static List<NameValuePair> getNameValueList(Map<String, String> params) {
